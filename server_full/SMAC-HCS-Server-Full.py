...
pretraining_num_layers = UniformIntegerHyperparameter('pretraining_num_layers', lower=4, upper=14, default_value=12)
pretraining_hidden_size = UniformIntegerHyperparameter('pretraining_hidden_size', lower=768, upper=1140,
                                                       default_value=768, q=12)
pretraining_linear_hidden_size = UniformIntegerHyperparameter('pretraining_linear_hidden_size', lower=108, upper=512,
                                                              default_value=256)
