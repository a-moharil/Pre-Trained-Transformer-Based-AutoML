...
embedding_ = np.array(tab_embeds, dtype=object)
...
final_stacker = pd.concat([embedding_dataframe,  tabular_df['AdoptionSpeed']], axis=1)



final_stacker.to_csv('/mnt/server-home/TUE/20210962/csv/albef_mod3_pf_embeds.csv')
...
predictor = TabularPredictor(label='AdoptionSpeed', problem_type='multiclass').fit(final_stacker,
