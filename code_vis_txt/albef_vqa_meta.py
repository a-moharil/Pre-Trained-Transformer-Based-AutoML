...
predictor = TabularPredictor.load('/mnt/server-home/TUE/20210962/AutogluonModels/ag-20230516_120118/') ##Change the dir
print(predictor.leaderboard(extra_info=True, silent=True))
print(type(predictor.leaderboard(extra_info=True, silent=True)))
predictor.leaderboard(extra_info=True, silent=True).to_csv('/mnt/server-home/TUE/20210962/csv/albef_vqa.csv')
sys.stdout.flush()
